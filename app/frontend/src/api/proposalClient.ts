 ...
 * artist names). The track id/name/artists live under `spotify_track`
 * (mirrors the Song schema; `artists` is optional/nullable exactly as the
 * backend `SpotifyTrack.artists: list[ArtistRef] | None`). */
