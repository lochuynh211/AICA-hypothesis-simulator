...
/**
 * useCaseSelection (bug 3 — store/wiring half) — selecting a test case must
 * reset `world.situation` to the newly-fetched case's baseline BEFORE its own
 * pinned `SET_SITUATION_FIELD` overrides are applied, so a previously
 * selected case's situation fields never linger into the next one.
 *
