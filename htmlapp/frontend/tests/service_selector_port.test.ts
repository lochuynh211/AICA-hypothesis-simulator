...
import { evaluate } from '../src/data/packages/builtin/aica_transparent_service_selector_v1'
import { loadFixture, expectParity } from '../src/engine/__fixtures__/parity'

describe('aica_transparent_service_selector_v1 parity', () => {
  it('reproduces Python evaluate() byte-for-byte over the representative case set', () => {
    const { input, output } = loadFixture('service_selector')
