/**
 * merged_quickview_gating.test.tsx (fixbug-0806) — htmlapp mirror of
 * app/frontend/tests/merged_quickview_gating.test.tsx. Covers the Combined
 * screen's recompute-collision fix:
